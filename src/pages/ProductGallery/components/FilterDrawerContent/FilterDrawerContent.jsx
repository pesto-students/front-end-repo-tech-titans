    ...
    <>
        ...
        <FormGroup>
          {categories.map(({ name, id }) => (
            <FormControlLabel
              control={
                <Checkbox
                  checked={filterConfig.category.includes(id)}
      ...
      <FormGroup sx={{ mb: 3 }} component="fieldset" variant="standard">
        ...
        >
          ...
          <OutlinedInput
            startAdornment={<InputAdornment position="start">₹</InputAdornment>}
            inputProps={{ min: filterConfig.priceRange.min }}
            placeholder="Max"
            type="number"
            size="small"
      ...
      <FormControl sx={{ mb: 2 }} component="fieldset" variant="standard">
        ...
        <FormGroup>
          <FormControlLabel
            control={
              <Checkbox
                checked={filterConfig.availability.includes("in_stock")}
          ...
          <FormControlLabel
            control={
              <Checkbox
                checked={filterConfig.availability.includes("out_of_stock")}
                onChange={(e) =>
